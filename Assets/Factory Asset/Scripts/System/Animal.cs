...
{
    public static Animal Instance { get; protected set; }
    ...
    private void MoveWASD(Vector3 move, float actualSpeed)
    {
        // Move around with WASD
    ...
    private void CheckOnGround(bool loosedGrounding)
    {
    ...
    private void CameraMovement(Vector3 move)
    {
        // Turn player
